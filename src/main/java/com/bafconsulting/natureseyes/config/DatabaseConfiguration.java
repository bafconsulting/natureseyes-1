package com.bafconsulting.natureseyes.config;

import com.bafconsulting.natureseyes.config.liquibase.AsyncSpringLiquibase;
...
@Configuration
@EnableJpaRepositories("com.bafconsulting.natureseyes.repository")
@EnableJpaAuditing(auditorAwareRef = "springSecurityAuditorAware")
@EnableTransactionManagement
@EnableElasticsearchRepositories("com.bafconsulting.natureseyes.repository.search")
